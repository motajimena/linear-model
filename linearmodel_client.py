...
#SERVER_URL = 'http://172.17.0.2:8501/v1/models/linear_model:predict'
SERVER_URL = 'https://linear-model-service-motajimena.cloud.okteto.net/v1/models/linear-model:predict'


def main():
    
  entrada = list(sys.argv[1])
